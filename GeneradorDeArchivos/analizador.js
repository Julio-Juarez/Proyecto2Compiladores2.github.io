...
function peg$parse(input, options) {
  ...
  var peg$f7 = function(cond, stmtIf, stmtElse) {return stmtElse};
  var peg$f8 = function(cond, stmtIf, stmtElse) {return crearNodo('if',{cond,stmtIf,stmtElse})};
  var peg$f9 = function(cond, stmt) {return crearNodo('while',{cond,stmt})};
  var peg$f10 = function() { return text() };
  var peg$f11 = function(id, asig) { return crearNodo('asignacion',{id,asig})};
