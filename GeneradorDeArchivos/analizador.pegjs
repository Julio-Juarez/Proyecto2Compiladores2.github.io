...
Stmt = "print(" _ exp:Expresion _ ")" _ ";" { return crearNodo('print', { exp }) }
    ...
    /"if" _ "(" _ cond: Expresion _ ")" _ stmtIf:Stmt stmtElse:(_ "else" _ stmtElse:Stmt {return stmtElse})? {return crearNodo('if',{cond,stmtIf,stmtElse})}
...
Asignacion = id:Identificador _ "=" _ asig:Asignacion { return crearNodo('asignacion',{id,asig})}
          /Comparacion
